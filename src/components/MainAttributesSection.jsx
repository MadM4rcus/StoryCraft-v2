          ...
          {['fa', 'fm', 'fd'].map(key => {
            ...
            return (
              <div key={key} className="flex flex-col items-center p-2 bg-gray-600 rounded-md">
                ...
                <div className="flex items-center gap-2">
                  <input type="number" id={key} name={key} value={baseValue || ''} onChange={handleSingleAttributeChange} className="w-14 p-2 text-center bg-gray-700 border border-gray-500 rounded-md text-white text-xl font-bold" disabled={!canEditGeneral} />
                  <span className="text-gray-300">=</span>
