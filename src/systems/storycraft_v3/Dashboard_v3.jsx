// src/systems/storycraft_v3/Dashboard_v3.jsx

import React, { useState, useEffect, useRef, useMemo } from 'react';
import CharacterList from './CharacterList_v3';
import CharacterSheet from './CharacterSheet_v3';
  ...
  return (
    ...
    <div className="w-full max-w-5xl mx-auto p-4 md:p-8">
      ...
      <header className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-bold text-textPrimary">Painel StoryCraft V3</h1>
